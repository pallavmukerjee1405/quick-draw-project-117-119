...
random_sketch_name=quick_draw_data_set[random_number];

document.getElementById("sketch_to_be_drawn").innerHTML="Sketch To Be Drawn : "+random_sketch_name;
...
if("sketch_to_be_drawn"==random_sketch_name){
    answer_holder="set";
    score=score+1;
